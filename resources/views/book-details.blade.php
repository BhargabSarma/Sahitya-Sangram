    ...
    <div class="max-w-7xl mx-auto px-4 py-32">
        <div class="flex flex-col md:flex-row gap-10 bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div class="flex-shrink-0 flex flex-col items-center md:items-start">
                <div class="rounded-xl overflow-hidden shadow-lg bg-gray-100 mb-6 book-cover-hover" style="max-width: 240px;">
                    <div class="shelf-books__item">
                        <div class="flip-container" id="book-flip">
                            <div class="flipper">
                                ...
                                <div class="back shelf-books__container flex items-center justify-center" style="background: #23243a;">
                                    <div class="shelf-books__image">
                ...
                <div class="flex flex-col gap-2 w-full">
                    <button class="w-full px-4 py-2 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition">
                        Hard Copy ₹{{ $book->hard_copy_price ?? '1690' }}
                        <span class="line-through text-gray-400 text-sm ml-2">2990</span>
                    </button>
                    <button class="w-full px-4 py-2 rounded-lg bg-indigo-100 text-indigo-700 font-semibold hover:bg-indigo-200 transition">
