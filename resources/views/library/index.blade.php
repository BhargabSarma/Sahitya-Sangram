                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ asset($book->book_file) }}" target="_blank" class="btn btn-primary">Read Book</a>
                            ...
                            @else
                                <a href="{{ route('library.review.form', $book->id) }}" class="btn btn-success mt-2">Leave a Review</a>
                            @endif
                        </div>
                    </div>
                </div>
